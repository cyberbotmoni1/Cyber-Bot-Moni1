module.exports.config = {
    ...
    version: "1.0.1",
    credits: "𝐓𝐄𝐀𝐌 𝐒𝐀𝐑𝐏𝐗 ☢️_𖣘 -𝐁𝐎𝐓 ⚠️☢️",
...
TAKE LOVE FROM 𝐓𝐄𝐀𝐌 𝐒𝐀𝐑𝐏𝐗 AND ALSO FROM 𝐙𝐈𝐒𝐀𝐍 🥰♻️
________________________\n\n𝐓𝐨 𝐯𝐢𝐞𝐰 𝐚𝐧𝐲 𝐜𝐨𝐦𝐦𝐚𝐧d

${global.config.PREFIX}Help\n${global.config.PREFIX} Manu

𝐁𝐎𝐓 𝐍𝐀𝐌𝐄 :𝐓𝐄𝐀𝐌 𝐒𝐀𝐑𝐏𝐗 ☢️_𝐙𝐈𝐒𝐀𝐍𖣘 -𝐁𝐎𝐓 ⚠️
...
`, attachment: fs.createReadStream(__dirname + "/cache/ullash.mp4")} ,threadID));
        ...
        try {
            ...
            (typeof threadData.customJoin == "undefined") ? msg = "╭•┄┅═══❁🌺❁═══┅┄•╮\n   আসসালামু আলাইকুম-!!🖤\n╰•┄┅═══❁🌺❁═══┅┄•╯ \n\n    ✨🆆🅴🅻🅻 🅲🅾🅼🅴✨\n\n                ❥𝐍𝐄𝐖~\n\n        ~🇲‌🇪‌🇲‌🇧‌🇪‌🇷‌~\n\n        [   {name} ]\n\n༆-✿ আপনাকে আমাদের࿐\n\n{threadName}\n\n🌺✨!!—এর পক্ষ-থেকে-!!✨🌺\n\n❤️🫰_ভালোবাস_অভিরাম_🫰❤️\n\n༆-✿আপনি_এই_গ্রুপের {soThanhVien} নং মেম্বার࿐\n\n╭•┄┅═══❁🌺❁═══┅┄•╮\n  🌸   সাথে সাথে আমাদের 𝐓𝐄𝐀𝐌 𝐒𝐀𝐑𝐏𝐗⚠️ এবং 𝐙𝐈𝐒𝐀𝐍_ এর পক্ষ থেকে অসংখ্য লাল গোলাপের ভালোবাসা☢️  🌸\n╰•┄┅═══❁🌺❁═══┅┄•╯" : msg = threadData.customJoin;
            msg = msg
