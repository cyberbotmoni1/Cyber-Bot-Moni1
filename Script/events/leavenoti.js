...
(typeof data.customLeave == "undefined") ? msg = "╭═════⊹⊱✫⊰⊹═════╮ \n ⚠️ গুরুতর ঘোষণা ⚠️\n╰═════⊹⊱✫⊰⊹═════╯\n\n{session}||{name} ভাই/বোন...\nএই মাত্র গ্রুপ থেকে নিখোঁজ হয়েছেন!\nগ্রুপবাসীদের পক্ষ থেকে গভীর উদ্বেগ ও\nচাপা কান্নার মাধ্যমে জানানো যাচ্ছে...\n\n— উনি আর নেই... মানে গ্রুপে নেই!\nকিন্তু হৃদয়ে থেকে যাবেন, আনএক্টিভ মেম্বার হিসেবে | \n\n⏰ তারিখ ও সময়: {time}\n⚙️ স্ট্যাটাস: {type} (𝐙𝐈𝐒𝐀𝐍 বস ও কি নিজ ইচ্ছায় গেলো নাকি আপনি কোনো ষড়যন্ত্র করে ঘাড় ধাক্কা দিয়ে বের করে দিলেন)\n\✍️ মন্তব্যকিও:র কী ফিলিংস হইছে এই বিচ্ছেদে?" : msg = data.customLeave;
